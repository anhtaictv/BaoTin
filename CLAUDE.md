...
- **KHÔNG bao giờ thêm dòng `Co-Authored-By: Claude ...` vào commit message khi commit/push lên remote của repo này.** Repo từng phải rewrite lại toàn bộ lịch sử git (filter-branch + force-push + xóa nhánh rác) để dọn sạch dòng này khỏi GitHub — không lặp lại.
