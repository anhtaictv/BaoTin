...
import { createQueryInterpreter, NoopQueryInterpreter, OllamaQueryInterpreter } from "./searchInterpreter.js";
...
describe("createQueryInterpreter", () => {
  it("returns NoopQueryInterpreter when LLM_PROVIDER is not 'ollama'", () => {
    const interpreter = createQueryInterpreter({
      LLM_PROVIDER: "none",
