...
class LegalLookupTab extends ConsumerStatefulWidget {
  const LegalLookupTab({super.key});

  @override
  ConsumerState<LegalLookupTab> createState() => _LegalLookupTabState();
}

class _LegalLookupTabState extends ConsumerState<LegalLookupTab> {
