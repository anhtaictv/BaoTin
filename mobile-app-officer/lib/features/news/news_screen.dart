...
/// Tin chính thức từ bocongan.gov.vn — đọc nguyên văn, tách hẳn khỏi luồng tin báo/tín hiệu
/// cần xác minh (CLAUDE.md #1/#2). Mở bài viết gốc bằng trình duyệt ngoài thay vì nhúng
/// WebView — không cần thêm dependency, và tránh mọi hiểu lầm rằng đây là nội dung do app
/// kiểm duyệt.
