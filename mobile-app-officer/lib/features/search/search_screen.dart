...
/// Ported từ dashboard-web/lib/features/search/search_tab.dart — admin/senior_officer-only,
/// cùng quy ước "luôn hiện, backend chặn bằng 403" như các tile khác trong AdminMenuScreen.
...
class _SearchScreenState extends ConsumerState<SearchScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Trợ lý tìm kiếm')),
      body: Padding(
