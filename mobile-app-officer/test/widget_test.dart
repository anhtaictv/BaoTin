...
import 'package:bao_tin_officer/app.dart';

void main() {
  testWidgets('App boots and shows a loading indicator while the auth gate resolves', (tester) async {
    await tester.pumpWidget(const ProviderScope(child: BaoTinOfficerApp()));

    // OfficerAuthGate's FutureBuilder starts in the loading state before secure-storage
